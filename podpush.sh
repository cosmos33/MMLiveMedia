...
function pod_push_repo()
{
	...
	pod repo push --sources='https://github.com/cosmos33/MMSpecs.git,https://git.wemomo.com/ios/Specs.git,https://git.wemomo.com/cv/Podspecs.git,https://git.wemomo.com/live/Podspecs.git' $REPONAME $SPECNAME $ISJSON $LOCAL --allow-warnings --skip-import-validation --skip-tests $STATIC $VERBOSE
}
...
pod spec lint --sources='https://github.com/cosmos33/MMSpecs.git,https://git.wemomo.com/ios/Specs.git,https://git.wemomo.com/cv/Podspecs.git,https://git.wemomo.com/live/Podspecs.git' $SPECNAME --allow-warnings --fail-fast $VALIDATION $STATIC $VERBOSE
