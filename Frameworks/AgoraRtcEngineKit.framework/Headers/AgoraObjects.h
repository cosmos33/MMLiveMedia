...
@property (assign, nonatomic) AgoraVideoCodecType videoCodecType;
...
- (instancetype _Nonnull)initWithChannelName:(NSString *_Nullable)channelName token:(NSString *_Nullable)token;
@end
...
- (instancetype _Nonnull)initWithDestinationInfo:(AgoraChannelMediaRelayInfo *_Nonnull)destinationInfo;
@end
