...
typedef NS_ENUM(NSInteger, AgoraVideoCodecType) {
    AgoraVideoCodecTypeDefault = 0,
    AgoraVideoCodecTypeH264 = 1,
    AgoraVideoCodecTypeH265 = 2,
};
...
typedef NS_ENUM(NSUInteger, AgoraAudioRemoteState) {
    ...
    AgoraAudioRemoteStateRunning = 1,
    AgoraAudioRemoteStateFrozen = 2,
};
...
typedef NS_ENUM(NSInteger, AgoraQualityLimitationReason) {
    AgoraLimitationReasonNone = 0,  // The bitrate and/or frame rate is not limited.
    AgoraLimitationReasonBandwidth = 1,  // The bitrate and/or frame rate is primarily limited due to congestion cues during bandwidth estimation.
};

typedef NS_ENUM(NSInteger, AgoraRenderVideoFrameType) {
    AgoraRenderVideoFrameTypeDefault = 0,
    AgoraRenderVideoFrameTypeCVPixelBuffer = 1,
};
...
typedef NS_ENUM(NSInteger, AgoraChannelMediaRelayEvent) {
    ...
    AgoraChannelMediaRelayEventSourceTokenExpire = 7,
    AgoraChannelMediaRelayEventDestinationTokenExpire = 8,
};
