...
- (NSString *)rtcEngineRequestSEI:(AgoraRtcEngineKit *_Nonnull)engine;
...
/**
 *  The statistics of local audio stream. Update every two seconds.
 *
 *  @param engine        The engine kit
 *  @param stats         The statistics of local audio, including numChannels, sent SampleRate, sent Bitrate;
 */
- (void)rtcEngine:(AgoraRtcEngineKit * _Nonnull)engine localAudioStats:(AgoraRtcLocalAudioStats * _Nonnull)stats;

- (void)rtcEngine:(AgoraRtcEngineKit * _Nonnull)engine localVideoQualityLimited:(AgoraRtcLocalVideoStats * _Nonnull)stats reason:(AgoraQualityLimitationReason)reason;
 ...
 *
 *  @param engine            The engine kit
 *  @param stats             The statistics of remote audio
 */
 ...
 *  @param engine  The engine kit
 *  @param uid     The user id
 *  @param state   Stopped // Default state, audio is started or remote user disabled/muted audio stream
 Running // Running state, audio can be displayed normally
 Frozen  // Remote audio is frozen, probably due to network issue.
 */
- (void)rtcEngine:(AgoraRtcEngineKit * _Nonnull)engine remoteAudioStateChangedOfUid:(NSUInteger)uid state:(AgoraAudioRemoteState)state;
...
#if TARGET_OS_IPHONE
- (int)setRenderVideoFrameParametersWithType:(AgoraRenderVideoFrameType)renderFrameType;
#endif
