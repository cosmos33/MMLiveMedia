...
音乐播放失败
*/
- (void)MMLiveEnginePusherMusicPlayFailed:(MMLiveEngine *)engine error:(NSError*)error;

/**
音乐播放完成
*/
- (void)MMLiveEnginePusherMusicPlayCompleted:(MMLiveEngine *)engine error:(NSError*)error;

/**
推流码率和分辨率变化
*/
- (BOOL)MMLiveEnginePusherLevelChange:(MMLiveEngine *)engine encodeSize:(CGSize)encodeSize videoBitrate:(int)videoBitrate;

/**
伴奏播放失败
*/
- (void)MMLiveEnginePusherEffectPlayFailed:(MMLiveEngine *)engine effectId:(int)effectId error:(NSError*)error;

/**
伴奏播放完成
*/
- (void)MMLiveEnginePusherPushEffectPlayCompleted:(MMLiveEngine *)engine effectId:(int)effectId error:(NSError*)error;

/**
推流地址变化
*/
- (void)MMLiveEnginePusherDidChangeStreamUrl:(MMLiveEngine *)engine;

/**
频道key过期需要更新key
*/
- (void)MMLiveEnginePusherRequestChannelKey:(MMLiveEngine *)engine;

/**
连线用户声波大小
*/
- (void)MMLiveEnginePusher:(MMLiveEngine *)engine reportAudioVolumeIndicationOfSpeakers:(NSDictionary *)volumes;

/**
udp下行观众的sei
*/
- (void)MMLiveEnginePusher:(MMLiveEngine *)engine didReceiveSEI:(NSString *)sei;
@end
